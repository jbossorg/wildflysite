[[index]]
= Wild**Fly** 14 Documentation
:ext-relative: {outfilesuffix}
:toc!:

image:images/splash_wildflylogo_small.png[WildFly, align="center"]

Welcome to the Wild**Fly** Documentation. The documentation for Wild**Fly** is
...
There is also the http://wildscribe.github.io/[Wild**Fly** Model Reference]
...
through creating a new Wild**Fly** subsystem extension, in order to add more
...
* The link:Client_Guide{outfilesuffix}[WildFly Client Configuration] guide walks you trough new Wild**Fly** client and how to use it.
