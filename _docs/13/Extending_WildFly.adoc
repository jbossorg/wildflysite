...
functionality of Wild**Fly** via an extension and the subsystem it installs.
The Wild**Fly** kernel is very simple and lightweight; most of the
capabilities people associate with an application server are provided
via extensions and their subsystems. The Wild**Fly** distribution includes
...
You should know how to download, install and run Wild**Fly**. If not please
